...
class PurchaseReceiveOrderServiceImpl: PurchaseReceiveOrderService  {
    @Autowired lateinit var purchaseReceiveOrderRepository: PurchaseReceiveOrderRepository
    @Autowired lateinit var employeeRepository: EmployeeRepository
    @Autowired lateinit var changeRateRepository: ChangeRateRepository
    @Autowired lateinit var responseObjectMap: ResponseObjectMap
    @Autowired lateinit var purchaseReceiveOrderDetailRepository: PurchaseReceiveOrderDetailRepository
    @Autowired lateinit var productRepository: ProductRepository
    @Autowired lateinit var purchaseOrderDetailRepository: PurchaseOrderDetailRepository
