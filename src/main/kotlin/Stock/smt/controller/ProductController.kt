...
class ProductController constructor(
    ...
    fun getById(@PathVariable id: Int): MutableMap<String, Any> =
        responseObjectMap.responseObj(productService.findProductById(id)!!)
    ...
    fun update(
        @PathVariable catId: Int,
        @PathVariable itmId: Int,
        @PathVariable id: Int,
    ...
    fun delete(@PathVariable id: Int): MutableMap<String, Any> =
        responseObjectMap.responseObj(productService.delete(id))

    @PreAuthorize("hasRole('ADMIN')")
    @PostMapping("/product/{id}")
    fun uploadImage(@PathVariable id: Int, @RequestParam photo: String): MutableMap<String, Any> =
        responseObjectMap.responseObj(productService.uploadImg(id, photo)!!)
...
//        response.setHeader(headerKey, headerValue)
    ...
    fun updateStockProduct(@PathVariable id: Int, @PathVariable qty: Int): MutableMap<String, Any> =
        responseObjectMap.responseObj(productService.updateStockProduct(id, qty))
