...
//    @PreAuthorize("hasAnyRole('ADMIN','USER')")
    ...
    fun saveAll(@RequestBody employee: Employee): MutableMap<String,Any> = responseObjectMap.responseObj(employeeService.addEmployee(employee)!!)
    @PreAuthorize("hasRole('ADMIN')")
    @PutMapping("/employee/{id}")
    fun updateObj(@PathVariable id: Int, @RequestBody employee: Employee): MutableMap<String,Any> = responseObjectMap.responseObj(employeeService.updateEmployee(id,employee)!!)
    @PreAuthorize("hasRole('ADMIN')")
