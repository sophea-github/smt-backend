...
class CustomerController {
    ...
    fun AddNew(@RequestBody t: Customer): MutableMap<String, Any> =
        responseObjectMap.responseObj(customerService.saveAll(t)!!)
    ...
    fun deleteData(@PathVariable id: Int): MutableMap<String, Any> =
        responseObjectMap.responseObj(customerService.delete(id))
